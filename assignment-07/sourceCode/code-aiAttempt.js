...
class EnemyBase {
  constructor(type, x, y) {
    ...
    this.dead = false;
    this.stallTime = 0;
    this.stallTimeThreshold = 1000 + Math.floor(Math.random() * 1000);
  }
...
//--------------------------------------------------------------------------------------------------------------------------------|Variables
// const enemyTypes = [
//   {img: "./assets/textures/enemySprites/guard.png", moveSpeed: 0.05, rotSpeed: 3, totalStates: 13},
// ];
const enemyTypes = [
  {texture: new Texture("enemySprites/guard.png"), moveSpeed: 0.9, rotSpeed: 3, totalStates: 13, health: 6},
  //{texture: new texture("environmentSprites/armor.png"), moveSpeed: 0.05, rotSpeed: 3, totalStates: 13, health: 4},
];
